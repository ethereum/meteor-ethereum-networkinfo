...
/**
 * Create an Ethereum network id aware collection using given collection.
 *
 ...
 */
function NetworkifiedCollection(mongoCollection) {
    var self = this;
...
NetworkifiedCollection.prototype._addToQuery = function(selector) {
    var self = this;
...
['find', 'findOne', 'insert', 'update', 'upsert', 'remove'].forEach(function(method) {
    NetworkifiedCollection.prototype[method] = function() {
        var selector = args[0],
        args = Array.prototype.slice.call(arguments, 1);

        return this._coll[method].apply(this._coll, [this._addToQuery(selector)].concat(args));
    }  
});
...
['allow', 'deny', 'rawCollection', 'rawDatabase'].forEach(function(method) {
    NetworkifiedCollection.prototype[method] = function() {
        return this._coll[method].apply(this._coll, arguments);
    }  
});
